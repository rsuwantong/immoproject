...
def list_agencies(postal_code,price):
    ...
    agency_fees_list = agency_fees_relevant[
        ["agency_code", "agency_name", "agency_address", "postal_code", "agency_fee_final"]]
    agency_fees_list.sort_values(by="agency_fee_final", inplace=True)
    agency_fees_list["agency_fee_final"] = [round(x) for x in agency_fees_list["agency_fee_final"]]

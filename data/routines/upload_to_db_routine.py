...
class EtlUploadDB(Routine):
    ...
    def run_routine(self):
        ...
        agency_fees = agency_fees[["agency_code", "agency_name", "agency_address", "postal_code", "city", "price_min",
                                   "agency_rate", "agency_fee_min_keuros"]]
        agency_fees.rename(columns={"price_min": "price_min_keuros"}, inplace=True)
        agency_fees['price_max_keuros'] = agency_fees.groupby(['agency_code'])['price_min_keuros'].transform(lambda x: x.shift(-1))
        agency_fees = agency_fees[["agency_code", "agency_name", "agency_address", "postal_code", "city", "price_min_keuros", "price_max_keuros",
                                   "agency_rate", "agency_fee_min_keuros"]]
        # TODO: remove index
